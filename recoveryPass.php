    ...
    if(isset($_POST["recover"])){
        ...
        if(mysqli_num_rows($sql) <= 0){
           ...
           <?php
            ...
            $mail->setFrom('discordrtmsamp@gmail.com', 'Password Reset');
            ...
            http://localhost/login-System/Login-System-main/reset_psw.php?token=$token
            ...
            if(!$mail->send()){
                ...
                ?>
                <!-- jika email berhasil dikirim maka update token di database -->
                <?php
$stmt = $conn->prepare("
    UPDATE users
    SET reset_token = ?,
